...
async function getOpenExpo( page, obj )
{
	const timeout = 8000;
	...
	sFilter += '_field_attive=1';		// Solo aperte

	baseUrl = 'https://servizi.anfi.it/esposizioni/search?'+sFilter;
