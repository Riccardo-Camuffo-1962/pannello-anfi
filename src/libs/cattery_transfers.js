...
async function getCatteryTransfers( page, obj, search='', who='' )
{
	const timeout = 8000;
	...
	baseUrl = 'https://servizi.anfi.it/passaggio/search?page='+page;

	if( search === 'cat' && who !== '' )
		sFilter = '&_field_gatto='+encodeURIComponent( who );
	if( search === 'owner' && who !== '' )
		sFilter = '&_field_idnuovoproprietario='+encodeURIComponent(who);

	baseUrl = 'https://servizi.anfi.it/passaggio/search?page='+page+sFilter;
...
export default getCatteryTransfers;
